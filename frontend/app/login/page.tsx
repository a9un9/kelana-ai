    ...
    <div className="min-h-screen flex flex-col font-sans selection:bg-blue-200 selection:text-blue-900 relative items-center justify-center pt-20 pb-12">
      ...
      <div className="w-full max-w-md bg-white/95 backdrop-blur-2xl border border-white/60 rounded-lg p-8 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3)]">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-extrabold bg-gradient-to-br from-blue-600 to-cyan-500 bg-clip-text text-transparent">Welcome Back</h2>
          <p className="text-slate-500 mt-2 font-medium">Sign in to plan your next journey</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full mt-2 bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-700 hover:to-cyan-600 text-white font-bold py-4 px-6 rounded-lg shadow-lg hover:shadow-xl transition-all transform active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
